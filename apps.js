...
function sumArray(testArray){ //eslint-disable-line
  ...
  console.log(summed);
  var message3 = testArray + ' was passed in as an array of numbers, and ' + summed + ' is their sum.';
  console.log(message3);
  return [summed, message3];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var multiplied = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
  console.log(multiplied);
  var message4 = 'The numbers ' + testArray + ' have a product of ' + multiplied + '.';
  console.log(message4);
  return [multiplied, message4];
}
